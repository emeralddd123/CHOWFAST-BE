# CHOWFAST-BE
The backend API for CHOWFAST

### Overview
This example is a simple RESTful API application in which a user can create / update / delete / find a food, by using the *Clean Architecture*.
...
#### Entities
Contains all the business entities an application consists of. In our example the *User* and the *Meal*.
#### Use Cases
